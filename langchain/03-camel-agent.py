...
task_specify_agent = CAMELAgent(task_specifier_sys_msg, ChatTongyi(temperature=0.3,dashscope_api_key=os.environ["DASHSCOPE_API_KEY"]))
...
assistant_agent = CAMELAgent(assistant_sys_msg, ChatTongyi(temperature=0.3,dashscope_api_key=os.environ["DASHSCOPE_API_KEY"]))
user_agent = CAMELAgent(user_sys_msg, ChatTongyi(temperature=0.3,dashscope_api_key=os.environ["DASHSCOPE_API_KEY"]))
